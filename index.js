...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5511998346168 (11) 99834-6168\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const premium=["5511998346168@s.whatsapp.net"]
			const frendsowner=["5511998346168@s.whatsapp.net"]
			const mod=["5511998346168@s.whatsapp.net"]
			const admnbotnumber=["5511998346168@s.whatsapp.net"]
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5511998346168@s.whatsapp.net'
                        /******ApiKey Input******/
